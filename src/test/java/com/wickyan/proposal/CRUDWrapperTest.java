...
public class CRUDWrapperTest {
    ...
    public void testDelete() {
        ...
        queryWrapper
                ...
                .ge("age", 12)
                .isNotNull("email");
        int result = userDao.delete(queryWrapper);
    ...
    public void testSelectMaps() {
        ...
        List<Map<String, Object>> maps = userDao.selectMaps(queryWrapper);//返回值是Map列表
    ...
    public void testSelectObjs() {
        ...
        List<Object> objects = userDao.selectObjs(queryWrapper);//返回值是Object列表
    ...
    public void testUpdate1() {
        ...
        int result = userDao.update(user, userUpdateWrapper);
